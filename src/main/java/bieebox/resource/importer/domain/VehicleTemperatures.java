...
public class VehicleTemperatures implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        VehicleTemperatures vehicleTemperatures = (VehicleTemperatures) o;
        if (vehicleTemperatures.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), vehicleTemperatures.getId());
    }
