...
public class ProductPhotoResource {
    ...
    private static final String ENTITY_NAME = "importerProductPhoto";
    ...
    public ResponseEntity<ProductPhotoDTO> createProductPhoto(@RequestBody ProductPhotoDTO productPhotoDTO) throws URISyntaxException {
    ...
    public ResponseEntity<ProductPhotoDTO> updateProductPhoto(@RequestBody ProductPhotoDTO productPhotoDTO) throws URISyntaxException {
