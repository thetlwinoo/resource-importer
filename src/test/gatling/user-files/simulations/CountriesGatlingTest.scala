...
class CountriesGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Countries entity")
        ...
        .repeat(2) {
            ...
            .get("/importer/api/countries")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new countries")
            .post("/importer/api/countries")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                ...
                , "isoNumericCode":"0"
                , "countryType":"SAMPLE_TEXT"
                , "latestRecordedPopulation":null
                , "continent":"SAMPLE_TEXT"
                , "region":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/importer${new_countries_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created countries")
            .delete("/importer${new_countries_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
