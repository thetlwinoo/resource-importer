...
/**
 * Performance test for the PaymentMethods entity.
 */
class PaymentMethodsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the PaymentMethods entity")
        ...
        .repeat(2) {
            ...
            .get("/importer/api/payment-methods")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new paymentMethods")
            .post("/importer/api/payment-methods")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "paymentMethodName":"SAMPLE_TEXT"
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created paymentMethods")
                .get("/importer${new_paymentMethods_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created paymentMethods")
            .delete("/importer${new_paymentMethods_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
