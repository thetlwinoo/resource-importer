...
/**
 * Performance test for the ProductSubCategory entity.
 */
class ProductSubCategoryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ProductSubCategory entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all productSubCategories")
            .get("/importer/api/product-sub-categories")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new productSubCategory")
            .post("/importer/api/product-sub-categories")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created productSubCategory")
                .get("/importer${new_productSubCategory_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created productSubCategory")
            .delete("/importer${new_productSubCategory_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
