...
public class PeopleResourceIntTest {
    ...
    private static final String DEFAULT_HASHED_PASSWORD = "AAAAAAAAAA";
    private static final String UPDATED_HASHED_PASSWORD = "BBBBBBBBBB";
    ...
    public void createPeople() throws Exception {
        ...
        assertThat(testPeople.getHashedPassword()).isEqualTo(DEFAULT_HASHED_PASSWORD);
        ...
        assertThat(testPeople.getFaxNumber()).isEqualTo(DEFAULT_FAX_NUMBER);
    ...
    public void getAllPeople() throws Exception {
        ...
        restPeopleMockMvc.perform(get("/api/people?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].hashedPassword").value(hasItem(DEFAULT_HASHED_PASSWORD.toString())))
    ...
    public void getPeople() throws Exception {
        ...
        restPeopleMockMvc.perform(get("/api/people/{id}", people.getId()))
            ...
            .andExpect(jsonPath("$.hashedPassword").value(DEFAULT_HASHED_PASSWORD.toString()))
    ...
    public void updatePeople() throws Exception {
        ...
        assertThat(testPeople.getHashedPassword()).isEqualTo(UPDATED_HASHED_PASSWORD);
        ...
        assertThat(testPeople.getFaxNumber()).isEqualTo(UPDATED_FAX_NUMBER);
