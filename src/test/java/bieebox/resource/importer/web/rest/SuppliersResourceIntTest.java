...
import bieebox.resource.importer.domain.Suppliers;
import bieebox.resource.importer.repository.SuppliersRepository;
import bieebox.resource.importer.service.SuppliersService;
import bieebox.resource.importer.service.dto.SuppliersDTO;
import bieebox.resource.importer.service.mapper.SuppliersMapper;
...
public class SuppliersResourceIntTest {
    ...
    public void createSuppliers() throws Exception {
        ...
        assertThat(testSuppliers.getDeliveryAddressLine1()).isEqualTo(DEFAULT_DELIVERY_ADDRESS_LINE_1);
        assertThat(testSuppliers.getDeliveryAddressLine2()).isEqualTo(DEFAULT_DELIVERY_ADDRESS_LINE_2);
        assertThat(testSuppliers.getDeliveryPostalCode()).isEqualTo(DEFAULT_DELIVERY_POSTAL_CODE);
        assertThat(testSuppliers.getDeliveryLocation()).isEqualTo(DEFAULT_DELIVERY_LOCATION);
        assertThat(testSuppliers.getPostalAddressLine1()).isEqualTo(DEFAULT_POSTAL_ADDRESS_LINE_1);
        assertThat(testSuppliers.getPostalAddressLine2()).isEqualTo(DEFAULT_POSTAL_ADDRESS_LINE_2);
        assertThat(testSuppliers.getPostalPostalCode()).isEqualTo(DEFAULT_POSTAL_POSTAL_CODE);
    ...
    public void checkDeliveryAddressLine1IsRequired() throws Exception {
        int databaseSizeBeforeTest = suppliersRepository.findAll().size();
        // set the field null
        suppliers.setDeliveryAddressLine1(null);
    ...
    public void checkDeliveryPostalCodeIsRequired() throws Exception {
        int databaseSizeBeforeTest = suppliersRepository.findAll().size();
        // set the field null
        suppliers.setDeliveryPostalCode(null);
    ...
    public void checkPostalAddressLine1IsRequired() throws Exception {
        int databaseSizeBeforeTest = suppliersRepository.findAll().size();
        // set the field null
        suppliers.setPostalAddressLine1(null);
    ...
    public void checkPostalPostalCodeIsRequired() throws Exception {
        int databaseSizeBeforeTest = suppliersRepository.findAll().size();
        // set the field null
        suppliers.setPostalPostalCode(null);
    ...
    public void updateSuppliers() throws Exception {
        ...
        assertThat(testSuppliers.getDeliveryAddressLine1()).isEqualTo(UPDATED_DELIVERY_ADDRESS_LINE_1);
        assertThat(testSuppliers.getDeliveryAddressLine2()).isEqualTo(UPDATED_DELIVERY_ADDRESS_LINE_2);
        assertThat(testSuppliers.getDeliveryPostalCode()).isEqualTo(UPDATED_DELIVERY_POSTAL_CODE);
        assertThat(testSuppliers.getDeliveryLocation()).isEqualTo(UPDATED_DELIVERY_LOCATION);
        assertThat(testSuppliers.getPostalAddressLine1()).isEqualTo(UPDATED_POSTAL_ADDRESS_LINE_1);
        assertThat(testSuppliers.getPostalAddressLine2()).isEqualTo(UPDATED_POSTAL_ADDRESS_LINE_2);
        assertThat(testSuppliers.getPostalPostalCode()).isEqualTo(UPDATED_POSTAL_POSTAL_CODE);
